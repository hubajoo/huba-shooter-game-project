...
namespace Tests.Mechanics
{
  ...
  public class MovementsTests
  {
    ...
    private Mock<ICellSurfaceWrapper> _mockCellSurfaceWrapper;
    ...
    public void SetUp()
    {
      ...
      _mockCellSurfaceWrapper = new Mock<ICellSurfaceWrapper>();
      _movements = new Movements(_mockMap.Object, _mockScreenObjectManager.Object, _mockCellSurfaceWrapper.Object);
    ...
    {
      _mockCellSurfaceWrapper.Setup(s => s.IsValidCell(_newPosition.X, _newPosition.Y)).Returns(true);
    ...
    {
      _mockCellSurfaceWrapper.Setup(s => s.IsValidCell(_newPosition.X, _newPosition.Y)).Returns(false);
