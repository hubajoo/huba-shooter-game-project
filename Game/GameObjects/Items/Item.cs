...
{
  protected Item(ColoredGlyph appearance, Point position, IScreenObjectManager screenObjectManager, IMap map) : base(appearance, position, screenObjectManager, map)
  {
