...
{
    public Dragon(Point position, IScreenSurface hostingSurface)
        : base(new ColoredGlyph(Color.Red, Color.Transparent, 1), position, hostingSurface, health: 20, damage: 20)
    {
        Health = 10;
    }
