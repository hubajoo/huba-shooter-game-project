...
public class Player : GameObject
{
    ...
    public void AddNewItemToInventory(Items items)
    {
        ...
        if (items is Shield shield)
        {
            BaseShield += shield.Amount;
    ...
    {
        return Inventory.Count(item => item is Sword);
    }

    public int GetPotionCount()
    {
        return Inventory.Count(item => item is Potion);
    }

    public int GetShieldCount()
    {
        return Inventory.Count(item => item is Shield);
    }
